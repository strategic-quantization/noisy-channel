...
for p_b=p_bval
    ...
    for r=1:rn % loop over initializations
        ...
        save(strcat('uniform_xycubed_fmincon_M',num2str(M),'pb',num2str(p_b),'a',num2str(a),'b',num2str(b),'.mat'),'xm','ym','dist_enc','dist_dec','erm','xrm','yrm','drm','xminit','exitrn','p_b');
    end
    toc
    % for r=1:rn
    ...
    save(strcat('uniform_xycubed_fmincon_M',num2str(M),'pb',num2str(p_b),'a',num2str(a),'b',num2str(b),'.mat'),'xm','ym','dist_enc','dist_dec','erm','xrm','yrm','drm','xminit','exitrn','numlocopt','cmp','cmpx','indx','p_b','ctr');
