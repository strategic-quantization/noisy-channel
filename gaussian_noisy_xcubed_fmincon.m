...
for p_b=p_bval
    ...
    save(strcat('gaussian_xcubedy_fmincon_M',num2str(M),'pb',num2str(p_b),'a',num2str(a),'b',num2str(b),'.mat'),'xm','ym','dist_enc','dist_dec','erm','xrm','yrm','drm','xminit','exitrn','numlocopt','cmp','cmpx','indx','p_b','ctr');
